...
import ActiveLink, { classNames } from './ActiveLink'
...
const navigation = [
  ...
  { name: 'Planner', href: '/plan', current: false },
    ...
    <div className="min-h-full">
      ...
      <div className="py-10">
        ...
        <footer className="text-center border-t border-gray-200">
          <span className='text-xs text-gray-500'>Copyright 2021 | Nutria</span>
        </footer>
      </div>
    </div>
  </>
